...
alphas<-c("Xiangfan","Ezhou","Xiaogan","Jingzhou","Suizhou")
...
df_alpha<-rbind(df_alpha,data.frame(name="Huanggang",long=114.52,lat=30.27))
...
geom_point(data = df_delta, aes(x = long, y = lat), color = 'green',size=1.5)
